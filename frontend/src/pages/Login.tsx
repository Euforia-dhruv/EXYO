  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-exyo-black">
        <img
          src="https://images.unsplash.com/photo-1574375927938-d5a98e8d7e28?w=1920&q=80"
          alt=""
      ...
      <div className="relative z-10 w-full max-w-lg px-5">
        ...
        <div className="bg-black/50 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-10 shadow-2xl shadow-black/60">
          <h2 className="text-[28px] font-bold text-white mb-1.5 tracking-tight">Welcome back</h2>
          <p className="text-gray-400 text-[15px] mb-8">Sign in to continue watching</p>
        ...
        <div className="mt-8 text-center text-[15px] text-gray-500">
          New to EXYO?{' '}
          <Link to="/register" className="text-white hover:text-exyo-red transition-colors font-semibold">
            Sign up now
          </Link>
        </div>
      </div>
