      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-medium">{content?.name || 'Now Playing'}</span>
          </div>
          <div className="w-12" />
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-3 relative group cursor-pointer">
              <div className="h-1 group-hover:h-1.5 bg-white/20 rounded-full transition-all relative">
                ...
                <div
                  className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-exyo-red rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <button onClick={() => skip(-10)} className="p-2 hover:bg-white/10 rounded-full transition-colors hidden md:block" title="Rewind 10s (←)">
              ...
              <button onClick={() => skip(10)} className="p-2 hover:bg-white/10 rounded-full transition-colors hidden md:block" title="Forward 10s (→)">
              ...
              <div className="flex items-center gap-1 group/vol">
                ...
                <input
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="w-0 group-hover/vol:w-20 transition-all duration-200 h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-exyo-red"
                />
              </div>
              ...
              <div className="relative">
                ...
                {showSettings && (
                  <div className="absolute bottom-full right-0 mb-2 bg-gray-900/95 backdrop-blur-sm rounded-lg p-2 min-w-[160px] border border-white/10">
