        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Manage your Stremio addons for content streaming.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <aside className="md:w-56 flex-shrink-0">
              <nav className="flex md:flex-col gap-1">
                ...
                <Link to="/settings/addons" className="px-4 py-2.5 text-sm font-medium rounded-lg bg-white/10 text-white transition-colors">
                  Addons
                </Link>
              </nav>
            </aside>
