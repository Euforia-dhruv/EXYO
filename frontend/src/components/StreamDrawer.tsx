...
function getProviderColor(name?: string): string {
  ...
  if (lower.includes('flix')) return 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20';
  if (lower.includes('notorrent')) return 'bg-amber-500/10 text-amber-400 border-amber-500/20';
