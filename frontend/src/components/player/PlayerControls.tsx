  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className="absolute top-0 left-0 right-0 p-5 flex items-center justify-between z-10 pointer-events-auto">
        <button onClick={onBack} className="p-2.5 hover:bg-white/10 rounded-2xl transition-colors">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 pb-6 z-10 pointer-events-auto">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-1.5">
            {/* Play/Pause */}
            <button onClick={onTogglePlay} className="p-2.5 hover:bg-white/10 rounded-2xl transition-colors">
              {isPlaying ? (
            ...
            <div className="flex items-center gap-0.5 group/vol">
              <button onClick={onToggleMute} className="p-2.5 hover:bg-white/10 rounded-2xl transition-colors">
                {isMuted || volume === 0 ? (
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
